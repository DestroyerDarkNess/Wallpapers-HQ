...
anywheresoftware.b4a.keywords.Common.LogImpl("62621460",_exeption,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("62490379",_exeption,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("62424843",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
