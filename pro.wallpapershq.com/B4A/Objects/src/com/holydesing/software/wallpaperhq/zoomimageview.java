...
public class zoomimageview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.holydesing.software.wallpaperhq.zoomimageview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.holydesing.software.wallpaperhq.zoomimageview.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(double _width,double _height) throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Public Sub Base_Resize (Width As Double, Height As";
