...
public class slidemenu extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.holydesing.software.wallpaperhq.slidemenu");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.holydesing.software.wallpaperhq.slidemenu.class).invoke(this, new Object[] {null});
        else
...
com.holydesing.software.wallpaperhq.slidemenu._actionitem _item = null;
...
_item = new com.holydesing.software.wallpaperhq.slidemenu._actionitem();
...
public String  _initialize(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.B4XViewWrapper _activity,Object _module,String _eventname,int _top,int _width) throws Exception{
innerInitialize(_ba);
 //BA.debugLineNum = 29;BA.debugLine="Sub Initialize(Activity As B4XView, Module As Obje";
...
_mlistview.getTwoLinesAndBitmap().ImageView.SetLayout(__c.DipToCurrent((int) (13)),__c.DipToCurrent((int) (13)),__c.DipToCurrent((int) (24)),__c.DipToCurrent((int) (24)));
 //BA.debugLineNum = 42;BA.debugLine="mListView.Color = Colors.ARGB(180,40, 42, 54)";
_mlistview.setColor(__c.Colors.ARGB((int) (180),(int) (40),(int) (42),(int) (54)));
 //BA.debugLineNum = 44;BA.debugLine="mInAnimation.InitializeTranslate(\"\", -Width, 0, 0";
_minanimation.InitializeTranslate(ba,"",(float) (-_width),(float) (0),(float) (0),(float) (0));
 //BA.debugLineNum = 45;BA.debugLine="mInAnimation.Duration = 200";
_minanimation.setDuration((long) (200));
 //BA.debugLineNum = 46;BA.debugLine="mOutAnimation.InitializeTranslate(\"Out\", Width, 0";
_moutanimation.InitializeTranslate(ba,"Out",(float) (_width),(float) (0),(float) (0),(float) (0));
 //BA.debugLineNum = 47;BA.debugLine="mOutAnimation.Duration = 200";
_moutanimation.setDuration((long) (200));
 //BA.debugLineNum = 49;BA.debugLine="Activity.AddView(mSlidePanel, 0, Top, Width, 100%";
_activity.AddView((android.view.View)(_mslidepanel.getObject()),(int) (0),_top,_width,(int) (__c.PerYToCurrent((float) (100),ba)-_top));
 //BA.debugLineNum = 51;BA.debugLine="mBackPanel.Initialize(\"mBackPanel\")";
_mbackpanel.Initialize(ba,"mBackPanel");
 //BA.debugLineNum = 52;BA.debugLine="mBackPanel.Color = Colors.Transparent";
_mbackpanel.setColor(__c.Colors.Transparent);
 //BA.debugLineNum = 53;BA.debugLine="Activity.AddView(mBackPanel, -100%x, 0, 100%x, 10";
