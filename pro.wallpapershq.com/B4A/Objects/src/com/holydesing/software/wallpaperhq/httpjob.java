...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.holydesing.software.wallpaperhq.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.holydesing.software.wallpaperhq.httpjob.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("930015493",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("929818885",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("929556741",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("929491212",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("929229061",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("929753352","Cannot send files from the assets folder.",0);
...
String _value = "";
String _s = "";
com.holydesing.software.wallpaperhq.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_fd = (com.holydesing.software.wallpaperhq.httpjob._multipartfiledata)(group17.Get(index17));
...
__c.LogImpl("929360133",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
