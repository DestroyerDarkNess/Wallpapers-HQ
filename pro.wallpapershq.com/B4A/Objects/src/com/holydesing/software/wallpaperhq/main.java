...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.holydesing.software.wallpaperhq", "com.holydesing.software.wallpaperhq.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.holydesing.software.wallpaperhq", "com.holydesing.software.wallpaperhq.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.holydesing.software.wallpaperhq.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
vis = vis | (activity2.mostCurrent != null);
...
_actionbarhomeclicked = false;
 //BA.debugLineNum = 27;BA.debugLine="Public RP As RuntimePermissions";
_rp = new anywheresoftware.b4a.objects.RuntimePermissions();
 //BA.debugLineNum = 29;BA.debugLine="Public DownloadedWallpapers As String '= File.Com";
_downloadedwallpapers = "";
