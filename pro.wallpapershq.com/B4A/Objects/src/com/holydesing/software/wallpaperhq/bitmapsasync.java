...
public class bitmapsasync extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.holydesing.software.wallpaperhq.bitmapsasync");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.holydesing.software.wallpaperhq.bitmapsasync.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_LoadFromFile(com.holydesing.software.wallpaperhq.bitmapsasync parent,String _dir,String _filename,int _maxwidth,int _maxheight) {
this.parent = parent;
this._dir = _dir;
...
com.holydesing.software.wallpaperhq.bitmapsasync parent;
String _dir;
String _filename;
int _maxwidth;
int _maxheight;
...
public anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _loadfromhttpjob(com.holydesing.software.wallpaperhq.httpjob _job,int _maxwidth,int _maxheight) throws Exception{
...
public ResumableSub_LoadFromHttpJob(com.holydesing.software.wallpaperhq.bitmapsasync parent,com.holydesing.software.wallpaperhq.httpjob _job,int _maxwidth,int _maxheight) {
this.parent = parent;
this._job = _job;
this._maxwidth = _maxwidth;
this._maxheight = _maxheight;
